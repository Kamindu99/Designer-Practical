  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <li class="nav-item dropdown dropdown2">
          <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" id="dropdownMenuButton" aria-expanded="false">
           ABOUT
          </a>
        ...
        <li class="nav-item dropdown dropdown2">
          ...
          <a class=" " href="#" role="button" data-bs-toggle="dropdown" id="dropdownMenuButton" aria-expanded="false">
            GALLERY
          </a>
        ...
        <li class="nav-item"  >
          <button type="button"  style={{color:"white",background:"black", marginLeft:"150px", border:" 1px solid white",padding:"3px",width:"140px"}} className="bg-dark" >FIND A HOTEL</button>
        </li>
      </ul>
    </div>
  </div>
