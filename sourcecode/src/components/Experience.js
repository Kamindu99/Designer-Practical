          ...
          <div class="row text-center text-lg-start">
            <div class="col-lg-4 col-md-4 col-6 abv">
              <a href="#" class="d-block mb-4 h-100">
                <img
                  ...
                  alt=""
                />
                <div class="carousel-caption" style={{fontSize:"22px",fontWeight:"bold",textShadow:" 1px 1px #000000"}}>MULTIPLY YOUR POINTS</div>
              </a>
            </div>
            <div class="col-lg-4 col-md-4 col-6 abv">
              <a href="#" class="d-block mb-4 h-100">
                <img
                  ...
                  alt=""
                />
                <div class="carousel-caption" style={{fontSize:"22px",fontWeight:"bold",textShadow:" 1px 1px #000000"}}>GET AWAY & SAVE MORE</div>
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-6 abv">
              <a href="#" class="d-block mb-4 h-100">
                <img
                  class="img-fluid img-thumbnail"
                  src="https://www.hilton.com/im/en/NoHotel/16712377/15516-loy-cb-bau-refresh-digital-site-placements-featured-offer-base.jpg?impolicy=crop&cw=975&ch=650&gravity=NorthWest&xposition=0&yposition=0&rw=641&rh=427/400x260"
                  alt=""
                />
                <div class="carousel-caption" style={{fontSize:"22px",fontWeight:"bold",textShadow:" 1px 1px #000000"}}>A NIGHT ON US</div>
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-6 abv">
              <a href="#" class="d-block mb-4 h-100">
                <img
                  ...
                  alt=""
                />
                <div class="carousel-caption" style={{fontSize:"22px",fontWeight:"bold",textShadow:" 1px 1px #000000"}}>3 NIGHTS UNDER $250</div>
              </a>
            </div>
            <div class="col-lg-4 col-md-4 col-6 abv">
              <a href="#" class="d-block mb-4 h-100">
                <img
                  ...
                  alt=""
                />
                <div class="carousel-caption" style={{fontSize:"22px",fontWeight:"bold",textShadow:" 1px 1px #000000"}}>EARN UP TO 3X POINTS ON EVERY STAY</div>
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-6 abv">
              <a href="#" class="d-block mb-4 h-100">
                <img
                  ...
                  alt=""
                />
                <div class="carousel-caption" style={{fontSize:"22px",fontWeight:"bold",textShadow:" 1px 1px #000000"}}>EARN UP TO 130K POINTS</div>
              </a>
            </div>
